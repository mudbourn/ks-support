...
# ONCE-GUARD: set receivedTier BEFORE granting to prevent double-fire
execute as @a[scores={streak=800..,receivedTier=0}] run scoreboard players set @s receivedTier 1
execute as @a[scores={streak=800..,receivedTier=1}] run function killstreak:give_tier1_loadout
execute as @a[scores={streak=800..,receivedTier=1}] run scoreboard players set @s tierHealCount 60
...
execute as @a[scores={streak=1200..,receivedTier=2}] run function killstreak:give_artifact
execute as @a[scores={streak=1200..,receivedTier=2}] run effect give @s minecraft:resistance infinite 2 true
execute as @a[scores={streak=1200..,receivedTier=2}] run effect give @s minecraft:speed infinite 0 true
execute as @a[scores={streak=1200..,receivedTier=2}] run effect give @s minecraft:fire_resistance infinite 0 true
execute as @a[scores={streak=1200..,receivedTier=2}] run playsound minecraft:entity.ender_dragon.growl master @a ~ ~ ~ 1 0.7 0.5
execute as @a[scores={streak=1200..,receivedTier=2}] run tellraw @a [{"text":"A ","color":"gray"},{"text":"Legendary Artifact","color":"aqua","bold":true},{"text":" has chosen ","color":"gray"},{"selector":"@s","color":"yellow"},{"text":". May mercy be with you all.","color":"gray"}]
execute as @a[scores={streak=1200..,receivedTier=2}] run scoreboard players set @s tierHealCount 60
