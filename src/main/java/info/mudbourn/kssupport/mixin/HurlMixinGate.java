...
/**
 * Gate plugin — only applies Hurl mixins if Hurl is loaded.
 */
public class HurlMixinGate implements IMixinConfigPlugin {

    private final boolean present = FabricLoader.getInstance().isModLoaded("hurl");
